...
[Installing ROCm on Linux](../../install/linux/install.rst). For verifying that the
installation was successful, refer to [Post-install actions and verification](../../install/linux/install.rst) and
