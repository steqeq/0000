...
`installation procedure <linux-install-docs:/tutorial/install-overview>`.
...
refer to the {doc}`Linux install guide <linux-install-docs:tutorial/install-overview>`. For any
