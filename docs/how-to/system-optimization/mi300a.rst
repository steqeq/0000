...
* **Increase the amount of allocatable memory**
  ...
  By default, when using a device allocator via HIP, it is only possible to allocate 96GB out of 
  a possible 128GB of memory on the MI300A. This limitation does not affect host allocations.
