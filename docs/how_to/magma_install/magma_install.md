...
Deep Learning applications. {numref}`rocm-compat-frameworks-flowchart-main` provides the sequential flow for the use of each framework. Refer to the ROCm Compatible Frameworks Release Notes for each framework's most current release notes at
...
:name: rocm-compat-frameworks-flowchart-main
---
align: center
---
