...
The following [image](#mi100-arch) shows the node-level architecture of a system that
...
The above [image](#mi100-block) shows the AMD Instinct accelerator with its PCIe Gen 4 x16
...
The execution units of the GPU are depicted in the above [image](#mi100-block) as Compute
...
The above [image](#mi100-gcd) shows the block diagram of a single CU of an AMD Instinct™
