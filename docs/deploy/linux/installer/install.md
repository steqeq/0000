...
```shell
sudo apt update
wget https://repo.radeon.com/amdgpu-install/5.5.2/ubuntu/focal/amdgpu-install_5.5.50502-1_all.deb
...
```shell
sudo apt update
wget https://repo.radeon.com/amdgpu-install/5.5.2/ubuntu/jammy/amdgpu-install_5.5.50502-1_all.deb
sudo apt install ./amdgpu-install_5.5.50502-1_all.deb
```
...
```shell
sudo yum install https://repo.radeon.com/amdgpu-install/5.5.2/rhel/8.6/amdgpu-install-5.5.50502-1.el8.noarch.rpm
```
...
```shell
sudo yum install https://repo.radeon.com/amdgpu-install/5.5.2/rhel/8.7/amdgpu-install-5.5.50502-1.el8.noarch.rpm
```
...
```shell
sudo yum install https://repo.radeon.com/amdgpu-install/5.5.2/rhel/9.1/amdgpu-install-5.5.50502-1.el8.noarch.rpm
```
...
```shell
sudo zypper --no-gpg-checks install https://repo.radeon.com/amdgpu-install/5.5.2/sle/15.4/amdgpu-install-5.5.50502-1.noarch.rpm
```
...
**Example:** If you want to install ROCm releases 5.3.3 and 5.5.2
...
driver, associated with the ROCm release v5.5.2, will be installed as its latest
release in the list.

```none
sudo amdgpu-install --usecase=rocm --rocmrelease=5.3.3
sudo amdgpu-install --usecase=rocm --rocmrelease=5.5.2
```
