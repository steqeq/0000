...
```shell
sudo yum install https://repo.radeon.com/amdgpu-install/5.3.2/rhel/8.7/amdgpu-install-5.3.50302-1.el8.noarch.rpm
```
...
```shell
sudo yum install https://repo.radeon.com/amdgpu-install/5.3.2/rhel/9.1/amdgpu-install-5.3.50302-1.el8.noarch.rpm
```
