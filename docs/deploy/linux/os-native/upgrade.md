...
echo 'deb [arch=amd64 signed-by=/etc/apt/keyrings/rocm.gpg] https://repo.radeon.com/amdgpu/5.5.2/ubuntu focal main' \
...
echo 'deb [arch=amd64 signed-by=/etc/apt/keyrings/rocm.gpg] https://repo.radeon.com/amdgpu/5.5.2/ubuntu jammy main' \
    | sudo tee /etc/apt/sources.list.d/amdgpu.list
sudo apt update
```
...
[amdgpu]
name=amdgpu
baseurl=https://repo.radeon.com/amdgpu/5.5.2/rhel/8.6/main/x86_64/
enabled=1
priority=50
gpgcheck=1
...
[amdgpu]
name=amdgpu
baseurl=https://repo.radeon.com/amdgpu/5.5.2/rhel/8.7/main/x86_64/
enabled=1
priority=50
gpgcheck=1
gpgkey=https://repo.radeon.com/rocm/rocm.gpg.key
...
[amdgpu]
name=amdgpu
baseurl=https://repo.radeon.com/amdgpu/5.5.2/rhel/9.1/main/x86_64/
enabled=1
priority=50
gpgcheck=1
gpgkey=https://repo.radeon.com/rocm/rocm.gpg.key
...
[amdgpu]
name=amdgpu
baseurl=https://repo.radeon.com/amdgpu/5.5.2/sle/15.4/main/x86_64
enabled=1
gpgcheck=1
gpgkey=https://repo.radeon.com/rocm/rocm.gpg.key
EOF
...
```shell
echo "deb [arch=amd64 signed-by=/etc/apt/keyrings/rocm.gpg] https://repo.radeon.com/rocm/apt/5.5.2 focal main" \
...
```shell
echo "deb [arch=amd64 signed-by=/etc/apt/keyrings/rocm.gpg] https://repo.radeon.com/rocm/apt/5.5.2 jammy main" \
    | sudo tee /etc/apt/sources.list.d/rocm.list
echo -e 'Package: *\nPin: release o=repo.radeon.com\nPin-Priority: 600' \
    | sudo tee /etc/apt/preferences.d/rocm-pin-600
sudo apt update
...
[ROCm-5.5.2]
name=ROCm5.5.2
baseurl=https://repo.radeon.com/rocm/rhel8/5.5.2/main
enabled=1
priority=50
gpgcheck=1
gpgkey=https://repo.radeon.com/rocm/rocm.gpg.key
...
[ROCm-5.5.2]
name=ROCm5.5.2
baseurl=https://repo.radeon.com/rocm/rhel9/5.5.2/main
enabled=1
priority=50
gpgcheck=1
gpgkey=https://repo.radeon.com/rocm/rocm.gpg.key
...
name=ROCm5.5.2
name=rocm
baseurl=https://repo.radeon.com/rocm/zyp/5.5.2/main
enabled=1
gpgcheck=1
gpgkey=https://repo.radeon.com/rocm/rocm.gpg.key
EOF
