...
for ver in 5.3.3 5.4.3 5.5.1 5.5.2; do
...
- Sample Multi-version installation
   ...
   ```shell
   sudo apt install rocm-hip-sdk5.5.2 rocm-hip-sdk5.3.3
   ```
...
- Sample Multi-version installation
   ...
   ```shell
   sudo yum install rocm-hip-sdk5.5.2 rocm-hip-sdk5.3.3
   ```
...
- Sample Multi-version installation
   ...
   ```shell
   sudo zypper --gpg-auto-import-keys install rocm-hip-sdk5.5.2 rocm-hip-sdk5.3.3
   ```
...
2. Add binary paths to the `PATH` environment variable.
   ...
   ```shell
   export PATH=$PATH:/opt/rocm-5.5.2/bin:/opt/rocm-5.5.2/opencl/bin
   ```
