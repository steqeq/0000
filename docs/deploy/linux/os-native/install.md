...
- Sample Multi-version installation
   ...
   ```shell
   sudo apt install rocm-hip-sdk5.0.2 rocm-hip-sdk5.1.1
   ```
...
- Sample Multi-version installation
   ...
   ```shell
   sudo yum install rocm-hip-sdk5.0.2 rocm-hip-sdk5.1.1
   ```
...
- Sample Multi-version installation
   ...
   ```shell
   sudo zypper --gpg-auto-import-keys install rocm-hip-sdk5.0.2 rocm-hip-sdk5.1.1
   ```
...
2. Add binary paths to the `PATH` environment variable.
   ...
   ```shell
   export PATH=$PATH:/opt/rocm-5.1.1/bin:/opt/rocm-5.1.1/opencl/bin
   ```
