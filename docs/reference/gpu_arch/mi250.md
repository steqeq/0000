...
[Figure 1](mi250-gcd) shows the components of a single Graphics Compute Die (GCD
...
The execution units of the GPU are depicted in [Figure 1](mi250-gcd) as Compute
...
```{figure} ../../data/reference/gpu_arch/image.001.png
---
scale: 100%
align: center
name: mi250-gcd
...
```{list-table} Table 1: Peak-performance capabilities of the MI250 OAM for different data types.
:header-rows: 1
:name: mi250-perf
...
[Table 1](mi250-perf) summarizes the aggregated peak performance of the AMD
...
```{figure} ../../data/reference/gpu_arch/image.002.png
---
scale: 100%
align: center
name: mi250-arch
...
[Figure 2](mi250-arch) shows the block diagram of an OAM package that consists
...
[Figure 3](mi250-block) shows the node-level architecture of a system that is
...
```{figure} ../../data/reference/gpu_arch/image.003.png
---
scale: 100%
align: center
name: mi250-block
...
[Figure 3](mi250-block) shows the node-level architecture of a system with AMD
