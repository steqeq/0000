...
* In a future ROCm release, the following samples will be removed from the `hip-tests` project.
  * `hipBusbandWidth` from <https://github.com/ROCm-Developer-Tools/hip-tests/tree/develop/samples/1_Utils/>
  * `hipCommander` from <https://github.com/ROCm-Developer-Tools/hip-tests/tree/develop/samples/1_Utils/>
