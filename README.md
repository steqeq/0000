...
* ROCm v3.9 and above will not set any *ldconfig* entries for ROCm libraries for multi-version installation.  You must use *LD_LIBRARY_PATH* to load the ROCm library version of choice.
